                    ...
                    if (signatureRelated(name)
                        ...
                        try {
                            if (name.endsWith(".SF")) {
                                ...
                                if (!found) {
                                    if (unparsableSignatures.get(alias) == null) {
                                        unparsableSignatures.put(alias,
                                                String.format(
                            ...
                            if (unparsableSignatures.get(alias) == null) {
                                    unparsableSignatures.put(alias, String.format(
            ...
            if (!digestMap.isEmpty()
                ...
                for (String s : sigMap.keySet()) {
                    if (!digestMap.containsKey(s)) {
                        if (unparsableSignatures.get(s) == null) {
                            unparsableSignatures.put(s, String.format(
