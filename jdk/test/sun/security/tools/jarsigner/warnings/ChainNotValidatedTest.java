...
public class ChainNotValidatedTest extends Test {
    ...
    private void start() throws Throwable {
        ...
        ProcessBuilder pb = new ProcessBuilder(KEYTOOL,
                ...
                "-storepass", PASSWORD,
                "-keypass", PASSWORD);
        OutputAnalyzer analyzer = ProcessTools.executeCommand(pb);
        PrintWriter writer = new PrintWriter(new File(CHAIN));
        writer.print(analyzer.getStdout());
        ...
        pb = new ProcessBuilder(KEYTOOL,
                ...
                "-storepass", PASSWORD,
                "-keypass", PASSWORD);
        analyzer = ProcessTools.executeCommand(pb);
        writer.print(analyzer.getStdout());
        writer.close();
        analyzer.shouldHaveExitValue(0);
