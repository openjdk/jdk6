...
public class BadNetscapeCertTypeTest extends Test {
    ...
    public static void main(String[] args) throws Throwable {
        FileInputStream fis = new FileInputStream(NETSCAPE_KEYSTORE_BASE64);
        FileOutputStream fos = new FileOutputStream(NETSCAPE_KEYSTORE);
        new BASE64Decoder().decodeBuffer(fis, fos);
        fis.close();
        fos.close();
