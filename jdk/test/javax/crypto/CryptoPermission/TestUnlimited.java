...
public class TestUnlimited {
    ...
    private static String getDefaultPolicy() throws Exception {
        String path = System.getProperty("java.home") + "/lib/security/java.security";
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (expectedStr.equals("") || expectedStr.equals("unlimited")) {
            expected = Result.UNLIMITED;

        } else if (expectedStr.equals("limited")) {
            expected = Result.LIMITED;

        } else if (expectedStr.equals("exception")) {
