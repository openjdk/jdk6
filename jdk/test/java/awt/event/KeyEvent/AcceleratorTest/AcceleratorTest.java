/*
  ...
  @run applet/manual=yesno main/othervm/policy=Allow.policy AcceleratorTest.html
*/
...
public class AcceleratorTest extends JApplet
{
    ...
    public void init()
    {
        ...
        jbu.setMnemonic(getExtendedKeyCodeForChar('\u042E'));
        ...
        menuItem.setAccelerator(KeyStroke.getKeyStroke(getExtendedKeyCodeForChar('\u0431'),
        ...
        ks = KeyStroke.getKeyStroke(getExtendedKeyCodeForChar('\u0436'), java.awt.event.InputEvent.ALT_DOWN_MASK);
    ...
    public static int getExtendedKeyCodeForChar(int c) {
        try {
            if (ekcForChar == null) {
                ekcForChar = java.awt.event.KeyEvent.class.getDeclaredMethod("getExtendedKeyCodeForChar",
                                                                             int.class);
                ekcForChar.setAccessible(true);
            }
            return ((Integer) ekcForChar.invoke(null, c)).intValue();
        } catch (NoSuchMethodException nsme) {
            throw new RuntimeException("Could not find KeyEvent.getExtendedKeyCodeForChar", nsme);
        } catch (IllegalAccessException iae) {
            throw new RuntimeException("Could obtain access to KeyEvent.getExtendedKeyCodeForChar", iae);
        } catch (InvocationTargetException ite) {
            throw new RuntimeException("Exception when running KeyEvent.getExtendedKeyCodeForChar", ite);
        }
    }
